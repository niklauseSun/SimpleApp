        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                function (styles) {
                    var icon = void 0;
                    if (checked) {
                        icon = disabled ? React.createElement(Icon, { name: 'check-square', style: [styles.icon, style] }) : React.createElement(Icon, { name: 'check-square', color: variables.brand_primary, style: [styles.icon, style] });
                    } else {
                        icon = disabled ? React.createElement(Icon, { name: 'border', style: [styles.icon, style] }) : React.createElement(Icon, { name: 'border', color: variables.brand_primary, style: [styles.icon, style] });
                    }
                    return React.createElement(
